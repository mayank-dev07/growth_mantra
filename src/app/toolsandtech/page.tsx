            ...
            <section className="flex flex-col md:flex-row justify-around items-start md:items-center px-5 md:px-10 py-12 bg-white rounded-lg shadow-lg">
                ...
                <div className="md:w-2/5 space-y-4 text-gray-700">
                    <div className="text-lg">
                        <strong>Maximize your reach and conversion potential with cutting-edge advertising platforms that deliver results:</strong>
                        <ul className="list-disc pl-5 mt-2 space-y-2">
                            <li className="flex items-center hover:text-[#16213E] transition duration-300">
                                <img src="/SuccessContact.png" alt="SuccessContact" className="w-5 h-5 mr-2" />
                                Google Ads, Facebook Ads, LinkedIn Ads, Twitter Ads, Microsoft Advertising, Amazon Ads
                            </li>
                            <li className="flex items-center hover:text-[#16213E] transition duration-300">
                                <img src="/SuccessContact.png" alt="SuccessContact" className="w-5 h-5 mr-2" />
                                Taboola, Outbrain
                        ...
                        <br />
                        <strong>Value Proposition:</strong> Whether through PPC on Google Ads or retargeting with AdRoll, our expertise ensures that every ad dollar is spent efficiently. We implement advanced strategies to target the right audience, drive traffic, and convert leads into sales.
                    </div>
                </div>
            </section>
            ...
            <section className="flex flex-col md:flex-row justify-around items-start md:items-center px-5 md:px-10 py-12 bg-[#16213E] rounded-lg shadow-lg">
                ...
                <div className="md:w-2/5 space-y-4 text-white">
                    <div className="text-lg">
                        ...
                        <br />
                        <strong className="text-white">Value Proposition:</strong> Our team integrates and optimizes CRMs like Salesforce and HubSpot, ensuring that your customer interactions are seamless, automated, and tailored to enhance sales and retention. From B2B outreach via LinkedIn Sales Navigator to end-to-end automation through Keap, we have the tools to scale your customer management efforts.
                    </div>
                </div>
            </section>
            ...
            <section className="flex flex-col md:flex-row justify-around items-start md:items-center px-5 md:px-10 py-12 bg-white rounded-lg shadow-lg">
                ...
                <div className="md:w-2/5 space-y-4 text-gray-700">
                    <div className="text-lg">
                        ...
                        <br />
                        <strong>Value Proposition:</strong> Our team uses advanced email marketing platforms like Klaviyo for eCommerce and ActiveCampaign for complex automation workflows. We build personalized journeys that increase engagement and maximize conversions, ensuring your message lands perfectly with every customer.
                    </div>
                </div>
            </section>
            ...
            <section className="flex flex-col md:flex-row justify-around items-start md:items-center px-5 md:px-10 py-12 bg-[#16213E] rounded-lg shadow-lg">
                ...
                <div className="md:w-2/5 space-y-4 text-white">
                    <div className="text-lg">
                        ...
                        <br />
                        <strong>Value Proposition:</strong> Whether scheduling posts on Hootsuite or creating stunning visuals on Canva, our team ensures that your social media strategy is well-coordinated and consistently engaging. We help you create, publish, and monitor posts across all platforms with ease.
                    </div>
                </div>
            </section>
            ...
            <section className="flex flex-col md:flex-row justify-around items-start md:items-center px-5 md:px-10 py-12 bg-white rounded-lg shadow-lg">
                ...
                <div className="md:w-2/5 space-y-4 text-gray-700">
                    <div className="text-lg">
                        ...
                        <br />
                        <strong>Value Proposition:</strong> With tools like SEMrush and Ahrefs, we ensure that your content ranks at the top of search results. From on-page SEO with Yoast to competitor analysis with Moz, we optimize your website and content to attract high-intent organic traffic.
                    </div>
                </div>
            </section>
            ...
            <section className="flex flex-col md:flex-row justify-around items-start md:items-center px-5 md:px-10 py-12 bg-[#16213E] rounded-lg shadow-lg">
                ...
                <div className="md:w-2/5 space-y-4 text-white">
                    <div className="text-lg">
                        ...
                        <br />
                        <strong>Value Proposition:</strong> Our expertise in tools like Google Analytics and Hotjar enables us to track every interaction on your site, turning data into actionable insights. We build custom dashboards with Looker Studio, ensuring that you always have visibility into your marketing performance.
                    </div>
                </div>
            </section>
            <section className="flex flex-col md:flex-row justify-around items-start md:items-center px-5 md:px-10 py-12 bg-white rounded-lg shadow-lg">
                ...
                <div className="md:w-2/5 space-y-4 text-gray-700">
                    <div className="text-lg">
                        ...
                        <br />
                        <strong>Value Proposition:</strong> From optimizing your Amazon listings to building a store on Shopify, our team ensures that your eCommerce presence is well-managed, streamlined, and designed to convert visitors into loyal customers.
                    </div>
                </div>
            </section>
            <section className="flex flex-col md:flex-row justify-around items-start md:items-center px-5 md:px-10 py-12 bg-[#16213E] rounded-lg shadow-lg">
                ...
                <div className="md:w-2/5 space-y-4 text-white">
                    <div className="text-lg">
                        ...
                        <br />
                        <strong>Value Proposition:</strong> Our team helps you scale efficiently by automating repetitive tasks and integrating your systems for seamless operations. Whether connecting platforms with Zapier or orchestrating customer journeys with MoEngage, we optimize every step of your workflow.
                    </div>
                </div>
            </section>
