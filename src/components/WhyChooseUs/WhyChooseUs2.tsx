  ...
  return (
    <>
      <div className="w-full h-full flex flex-col ">
        <div className="h-full w-full flex flex-col md:flex-row pt-12 ">
          <div className="w-full px-4 lg:px-10 xl:px-16 flex flex-col gap-4 justify-center  items-center ">
            <div className="w-full flex flex-col gap-4 p-1 px-2 lg:px-0 justify-center  items-center">
              <div className="text-2xl md:text-3xl font-semibold flex flex-col gap-4 text-center tracking-widest text-[#E74C3C]">
            ...
            {services.map((service, index) => (
              ...
              >
                <div className="flex-grow">
                  <h3 className="text-xl md:text-4xl text-[#E74C3C] font-bold text-center py-3">
                    {service.title}
                  </h3>
        ...
        <div className="w-full h-full bg-[#E74C3C]">
