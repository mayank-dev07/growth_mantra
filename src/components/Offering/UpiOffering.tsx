...
const services = [
  ...
  },
  {
    ...
    description: "Reveal customer motivations through expert qualitative research.",
  ...
  },
  {
    ...
    description: "Visualize customer journeys to improve engagement opportunities",
    ...
    <>
      <section className="bg-[#576D2C] p-4 lg:p-10 text-white w-full">
        <div className="text-start mb-8 flex flex-col gap-3 md:gap-6">
          <h2 className="text-5xl lg:text-7xl font-bold mb-2">Our UpiOffering</h2>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 grid-rows-1 lg:grid-cols-1 lg:w-[32.5%] mt-6 lg:grid-rows-1 gap-6 sm:px-10 lg:px-0 lg:mx-auto">
  {service2.map((service2, index) => (
    <div
      key={index}
      className="bg-white text-[#576D2C] p-4 sm:p-6 lg:p-8 rounded-2xl shadow-md hover:shadow-xl transition-shadow duration-300 flex flex-col"
    >
      ...
      <div className="flex flex-col gap-4 mt-8">
        ...
        <div className="flex items-center">
          <CheckmarkIcon />
          <p className="text-lg text-black font-semibold">{service2.point1}</p>
        </div>

        {/* Checkpoint 2 */}
        <div className="flex items-center">
          <CheckmarkIcon />
          <p className="text-lg text-black font-semibold">{service2.point2}</p>
        </div>

        {/* Checkpoint 3 */}
        <div className="flex items-center">
          <CheckmarkIcon />
          <p className="text-lg text-black font-semibold">{service2.point3}</p>
        </div>
      </div>
