...
const services = [
  {
    ...
    description:
      "Data-driven, creative outreach generating high-quality leads at scale.",
    point1: "Cold outreach failing?",
    point2: "Low response rates?",
    point3: "Struggling to reach decision-makers?",
  },
  {
    title: "Sales Funnel Optimization",
    description:
      "Transform your funnel into a streamlined conversion powerhouse.",
    point1: "High lead drop-off rates?",
