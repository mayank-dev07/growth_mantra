...
const services = [
  {
    ...
    description: "Identify your total addressable market (TAM) and key segments to focus your GTM efforts",
    ...
    <>
      <section className="bg-[#576D2C] p-4 lg:p-10 text-white w-full">
        <div className="text-start mb-8 flex flex-col gap-3 md:gap-6">
          <h2 className="text-5xl lg:text-7xl font-bold mb-2">Our MarketOffering</h2>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 grid-rows-1 lg:w-[33%] lg:grid-cols-1 lg:grid-rows-1 gap-6 sm:px-10 lg:px-0 mt-6 lg:mx-auto">
