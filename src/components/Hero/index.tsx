...
const Hero = (props: Props) => {
  return (
    <>
      <div className=" min-h-screen w-full pt-28 px-6 flex">
        <div className=" w-8/12">
          <Image src="/Frame.png" alt="frame" width={400} height={400} />
          <div className="px-20 flex flex-col h-full gap-8">
            <div className="w-fit p-4 text-lg font-medium tracking-wider text-[#E74C3C] bg-[#FFEDEB] rounded-xl">
              👋 Welcome to The Growth Mantra
            </div>
            <div className="text-9xl font-medium flex flex-col gap-4">
              Your North Star
              <div className="flex items-center gap-5">
                <div className="border-[#E74C3C] py-4 px-12 border-4 w-fit rounded-full text-[#E74C3C] font-medium shadow-2xl">
                  Growth
                </div>
                Catalyst
              </div>
        ...
        <div className="bg-green-700 w-4/12"></div>
      </div>
