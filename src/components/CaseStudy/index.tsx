    ...
    <>
      <div className="w-full h-full bg-[#16213E] px-4 lg:px-16  py-32">
        <div className="w-full h-full bg-white flex flex-col lg:flex-row justify-between itms-center">
          <div className="w-full flex flex-col justify-start items-center text-2xl lg:text-3xl text-[#E74C3C] py-8 px-6 lg:px-12">
        ...
        <div className="rounded-3xl w-full bg-[#E74C3C] h-full ">
          ...
          <div className="w-full flex flex-col lg:flex-row justify-start items-start h-full pb-20 px-16 lg:px-6 gap-8">
            <div className="w-full lg:w-1/3 h-full m-0 lg:m-4">
              <div className=" h-[500px] rounded-3xl grid grid-cols-1 content-between text-2xl">
                <div className="w-full flex flex-col justify-start items-center px-2 xl:px-12 text-white">
                  Explore our latest articles and case studies to stay ahead in
                  your industry.
                  <div className="py-8 w-full flex justify-center items-center">
                    <div className="group rounded-full w-full px-4 py-4 flex text-lg hover:text-white hover:bg-[#E74C3C] bg-white text-[#E74C3C] border-[1px] shadow-xl tracking-wider justify-between items-center gap-3 cursor-pointer transition-all duration-500 ease-in-out font-bold">
                      <p>Schedule&nbsp;a&nbsp;call</p>
                      <div className="p-3 group-hover:bg-white rounded-full text-white bg-[#E74C3C] group-hover:text-[#E74C3C]">
                        <ArrowRight />
                      </div>
      ...
      <div className="h-full flex flex-col lg:flex-row justify-center items-stretch px-0 lg:px-32 py-10">
        <div className="w-full h-full lg:w-1/2 bg-[#E84C3D] text-white p-8 lg:p-20 rounded-[3%] shadow-2xl flex flex-col">
          <div className="text-5xl">Diagnose Your Growth Blockers</div>
          <div className="py-6 text-xl flex-grow">
          ...
          <div className="py-4 w-full flex justify-start items-center">
            <div className="group rounded-full w-fit px-4 lg:px-6 py-2 flex text-base lg:text-xl hover:text-white hover:bg-[#E74C3C] bg-white text-[#E74C3C] shadow-xl tracking-wider justify-between items-center gap-4 cursor-pointer transition-all duration-500 ease-in-out font-bold">
        ...
        <div className="w-full h-full lg:w-1/2 text-[#E84C3D] bg-white p-8 lg:p-20 rounded-[3%] shadow-2xl flex flex-col">
          <div className="text-5xl">Partner with Proven Growth Catalysts</div>
          <div className="py-6 text-xl flex-grow">
            {`Looking for more than just advice? Our team of seasoned consultants doesn't just strategize - we execute. From refining your go-to-market strategy to optimizing your product for scalability, we're here to drive tangible results and exponential growth for your startup.`}
          </div>
          <div className="py-4 w-full flex justify-start items-center">
            <div className="group rounded-full w-fit px-4 lg:px-6 py-2 flex text-base lg:text-xl hover:text-white hover:bg-[#E74C3C] bg-white text-[#E74C3C] shadow-xl tracking-wider justify-between items-center gap-4 cursor-pointer transition-all duration-500 ease-in-out font-bold">
