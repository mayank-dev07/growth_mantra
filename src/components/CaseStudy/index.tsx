  ...
  return (
    <>
      <div className="w-full h-full bg-[#16213E] px-4 lg:px-16  py-32">
        ...
        <div className="rounded-3xl w-full bg-[#E74C3C] h-full ">
          <div className="w-full flex justify-center items-center">
            <div className="py-10 w-11/12 lg:w-8/12 grid grid-cols-2 lg:grid-cols-4 gap20 xl:gap-10">
              <div className="w-full flex justify-center items-center">
                <p className="px-20 lg:px-16 w-full py-3 flex justify-center items-center border-white border-[1px] bg-transparent text-white rounded-full font-bold transition-all hover:bg-white hover:text-[#E74C3C]">
                  All&nbsp;Work[20]
                </p>
              </div>
              <div className="w-full flex justify-center items-center">
            ...
            <div className="w-full lg:w-1/3 h-full m-0 lg:m-4">
              <div className=" h-[450px] rounded-3xl grid grid-cols-1 content-between text-2xl ">
                <div className="w-full flex flex-col justify-start items-center  lg:px-8 text-white">
                  ...
                  your industry.
                  <div className="py-8 w-full flex justify-start items-center">
                    <div className="group rounded-full w-fit px-4 py-2 flex text-base hover:text-white hover:bg-[#E74C3C] bg-white text-[#E74C3C] border-[1px] shadow-xl tracking-wider justify-between items-center gap-4 cursor-pointer transition-all duration-500 ease-in-out font-bold">
                      <p>Schedule&nbsp;a&nbsp;call</p>
                      <div className="p-3 group-hover:bg-white rounded-full text-white bg-[#E74C3C] group-hover:text-[#E74C3C]">
                        <ArrowRight />
                      </div>
      ...
      <div className="min-h-screen flex flex-col md:flex-row justify-center items-center px-4 py-10 xl:px-32">
        <div className="w-full h-fit lg:w-1/2 bg-[#E84C3D] text-white p-8  md:p-16 lg:p-10 rounded-[3%] shadow-2xl">
          ...
          <div className="py-4 w-full flex justify-start items-center">
            <div className="group rounded-full w-fit px-4 lg:px-6 py-2 flex text-base hover:text-white hover:bg-[#E74C3C] bg-white text-[#E74C3C]   shadow-xl tracking-wider justify-between items-center gap-4 cursor-pointer transition-all duration-500 ease-in-out font-bold">
        ...
        <div className="w-full h-fit lg:w-1/2 text-[#E84C3D] bg-white p-8  md:p-16 lg:p-10 rounded-[3%] shadow-2xl">
          <div className="text-4xl lg:text-5xl min-h[100px]">
          ...
          <div className="py-4 w-full flex justify-start items-center">
            <div className="group rounded-full w-fit px-4 lg:px-6 py-2 flex text-base hover:bg-white hover:text-[#E74C3C] text-white bg-[#E74C3C] border-[1px] shadow-xl tracking-wider justify-between items-center gap-4 cursor-pointer transition-all duration-500 ease-in-out font-bold">
