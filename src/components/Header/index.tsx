      ...
      <div className="flex flex-col justify-center items-center fixed top-0 left-0 right-0 bg-white z-50">
        ...
        <div className="w-full h-full hidden md:flex justify-center items-center gap-2 md:gap-3 text-sm md:text-lg lg:gap-10 py-4">
          <Dropdown overlay={consultingMenu} placement="bottomCenter" trigger={['click']}>
            <div className="cursor-pointer text-[#6F6F6F] hover:text-[#16213E]">Consulting</div>
          </Dropdown>
          <Dropdown overlay={servicesMenu} placement="bottomCenter" trigger={['click']}>
            <div className="cursor-pointer text-[#6F6F6F] hover:text-[#16213E]">Services</div>
          </Dropdown>
          <Link href="/contactus">
            <span className={`${isActive("/contactus") ? "text-[#16213E]" : "text-[#6F6F6F]"}`}>
              Contact&nbsp;us
            </span>
          </Link>
          <Link href="/aboutus">
            <span className={`${isActive("/aboutus") ? "text-[#16213E]" : "text-[#6F6F6F]"}`}>
              About&nbsp;us
            </span>
          </Link>
        </div>
